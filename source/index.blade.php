...
<div class="h-100 w-100 d-flex flex-column">
	...
	<footer class="landing-footer py-4 mx-auto w-100">
		<div class="card-group justify-content-md-center px-5">
			...
			<div class="card-body text-center py-3 px-3 mx-auto"><a target="_blank" href="/assets/files/devconf-brand-guidelines-v1.pdf">Brand Guidelines</a></div>
		</div>
	</footer>
</div>
@endsection

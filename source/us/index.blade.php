...
<header class="masthead min-vh-100">
	...
	<div class="row mr-0 mt-5" style="height: 85%">
		...
		<div class="col-lg-10 h-100 px-0">
			...
			<i class="fa fa-map-marker"></i> Boston, USA: <a href="https://maps.app.goo.gl/Cse5KCG9Lr8wgWjJ8" target="_blank" class="text-white" style="text-decoration: underline">43 Hawes Street, Brookline, MA 02446</a>
			</div>
			<!-- <div class="heading-text mont-400 h5 pb-2 pb-lg-5">
            <a href="https://maps.app.goo.gl/Cse5KCG9Lr8wgWjJ8" target="_blank" class="text-white">Full Address: 43 Hawes Street, Brookline, MA 02446</a>
        	</div> -->
			<div class="heading-text mont-400 h5 pt-1 mt-4">
                 Online ticket sales are now closed. At-the-door registration will be available at the venue on a first-come, first-served basis as capacity allows.
			</div>
			<div class="heading-text mt-4">
				<a href="/us/schedule/" class="border p-3 h2 mont-700" style="border-width: 3px !important;">SCHEDULE</a>
			</div>
			<div class="heading-text mt-4">
				<a href="https://matrix.to/#/#general-us:devconf.cz" class="border p-3 h2 mont-700" style="border-width: 3px !important;">JOIN MATRIX TO ATTEND ONLINE</a>
			</div>
		</div>
	</div>
</header>
...
<section id="about" class="mx-auto col-lg-11">
	<div class="row mt-4 py-5">
		...
		<div class="col-lg-6 px-5">
			...
			<div class="os-400">
                <p>DevConf.US is a free, Red Hat sponsored technology conference for community project and professional contributors to Free and Open Source technologies
...
<section id="news" class="mx-auto py-5 col-lg-11">
	...
	<div class="row">
		<div class="col-10 col-md-5 mr-md-0 mx-auto py-3 border-bottom">
			<div class="row">
				<div class="col-4 h5 mont-700">March 2, 2026</div>
				<div class="col-8">
					<div class="row">
		...
		<div class="col-10 col-md-5 ml-md-0 mx-auto py-3 border-bottom">
			<div class="row">
				<div class="col-4 h5 mont-700">April 27, 2026</div>
				<div class="col-8">
					<div class="row">
	...
	<!-- <div class="row">
		<div class="col-10 col-md-5 mr-md-0 mx-auto py-3 border-bottom">
			<div class="row">
				<div class="col-4 h5 mont-700">September 18, 2025</div>
				<div class="col-8">
					<div class="row">
						<div class="col mont-600">Day 0: vLLM Meetup</div>
					</div>
				</div>
			</div>
		</div>
		<div class="col-10 col-md-5 ml-md-0 mx-auto py-3 border-bottom">
			<div class="row">
				<div class="col-4 h5 mont-700">September 19-20, 2025</div>
				<div class="col-8">
					<div class="row">
						<div class="col mont-600">DevConf.US 2025</div>
					</div>
				</div>
			</div>
		</div>
...
<section id="news" class="mx-auto py-5 col-lg-11">
	...
	<div class="row">
		<div class="col-lg-6 px-5 mx-auto">
			...
			<p class="os-400"><span class="h6 mont-700">June 29, 2026</span> Schedule published and Registration is open!</p>
			<p class="os-400"><span class="h6 mont-700">April 20, 2026</span> Call for Proposals deadline extended to April 27, 2026 at 11:59pm ET</p>
			<p class="os-400"><span class="h6 mont-700">March 2, 2026</span> Call for Proposals is open, deadline to submit proposals is April 20, 2026</p>
			<p class="os-400"><span class="h6 mont-700">March 2, 2026</span> DevConf.US 2026 date announced: September 24-25, 2026</p>

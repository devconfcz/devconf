...
@section('title')
<title>Getting to Framingham - DevConf.US</title>
@endsection
...
<section class="mx-auto mt-5 pt-5 pb-3 col-lg-11">
	<div class="row">
		<div class="h1 mx-5 mont-700 underline position-relative">Getting to Framingham</div>
	</div>
...
<section class="mx-auto col-lg-11">
	<div class="row">
		<div class="os-400 mx-5 text-center" style="min-height: 40vh">
			<strong class="d-block mb-3 os-600">We will post our 'Getting to Framingham' in January 2020.</strong>
		</div>
	</div>
</section>
@endsection

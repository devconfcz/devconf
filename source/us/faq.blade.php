	...
	$questions = array(
		...
		array("group" => "Speaker Questions", "id" => "speaker", 
			"questions" => array( 
				...
				array("q" => "How should I submit the pre-recorded video?", "a" => "We recommend uploading the video to YouTube as unlisted. We will send out an email with instructions on how to submit the YouTube link of your video. <br><br> If you would prefer to not to use YouTube, send the organizers an email at <a href='mailto:info@devconf.us'>info@devconf.us</a> and we will work with you to figure out alternate options."),
				...
				array("q" => "How does speaker coaching work?", "a" => "The speaker confirmation form invites new speakers to sign up for practicing their talks via a video conference ahead of DevConf.US and invites experienced speakers to coach new speakers through such practice. We hope that participating in this program will improve the experience of new speakers and improve the quality of talks at DevConf.US, and highly encourage experienced speakers to sign up as coaches. We have a speaker guide and a speaker coaching guide available to support speakers and coaches. People who sign up, will receive their coaching matches by July 1, with the expectation that they will schedule practice sessions between July 6 and July 20. <br><br>We ask the coaches to take the lead on scheduling the practice session via a video conference (BlueJeans, Talky.io, Jitsi Meet, Zoom, Google Meet, Skype, etc). The speaker can choose to invite other audience members to the practice. In the practice session, the speaker delivers their practice talk, and the coach and other audience members provide feedback on the talk and slide deck. <br><br>Speakers and coaches agree to abide by the DevConf Code of Conduct both during the conference and in any pre-conference coaching, practice, or other program related activities."),

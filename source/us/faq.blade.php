	...
	$questions = array(
		...
		array("group" => "Speaker Questions", "id" => "speaker", 
			...
			"questions" => array( 
				...
				array("q" => "Can I use my existing Matrix account?", "a" => "Absolutely! #2024.us:devconf.cz rooms are public and <a href='https://matrix.org/faq/#what-does-federated-mean%3F' target='_blank'>federated</a>, which means you can use your existing account to join. Open <a href='https://matrix.to/#/#main.us:devconf.cz' target='_blank'>https://matrix.to/#/#main.us:devconf.cz</a> to get started."),

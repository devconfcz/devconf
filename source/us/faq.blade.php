	...
	$questions = array(
		array("group" => "General Questions", "id" => "general", 
			"questions" => array( 
				...
				array("q" => "Do you provide visa invitation letters?", "a" => "Yes, we can provide a visa invitation letter to accepted speakers only. You will get details about this in the acceptance notification."),
		...
		array("group" => "CfP Questions", "id" => "cfp", 
			"questions" => array( 
				...
				array("q" => "What is a workshop?", "a" => "A workshop is a hands-on demo where you and other workshop leads interact with the audience with the goal to share your knowledge and experience on a particular bite-sized topic. The goal of a workshop is to teach or practice a skill. As a result, workshops should be actionable and goal-oriented.</p><p><strong>A workshop is 80 minutes long.</strong> We allow up to <strong>2 active presenters</strong> in a workshop. You must designate one of them to be the primary session leader.</p><p><strong>All workshops are conducted live and are not recorded by default.</strong>"),
				...
				array("q" => "Where is the schedule? When will the schedule be ready?", "a" => "We will release the schedule in June 2026."),
				array("q" => "When should I expect to receive an acceptance notification by?", "a" => "We receive a large number of high quality submissions. We plan to send out acceptances by May 2026."),
		...
		array("group" => "Registration Questions", "id" => "registration", 
			"questions" => array( 
				array("q" => "How much does it cost to attend DevConf.US?  Do I need to register?", "a" => "Admission to DevConf.US is free and only requires that you register. Registration details will be available by June 2026."),
		...
		array("group" => "Speaker Questions", "id" => "speaker", 
			"questions" => array( 
				...
				array("q" => "Are there any tips and tricks for composing and delivering a successful talk at DevConf.US?", "a" => "To assist you with producing your talk, we are collecting a list of suggestions for both virtual and in-person speakers in the <a href='/us/speakerguide/' target='_blank'>speaker guide</a>."),
				 array("q" => "What kind of project/speakers/audio-visual equipment do you provide?", "a" => "Every session room will have a projector that should accept most common display technologies. If you do not have an HDMI port on your laptop, please bring an adapter to ensure you can connect. While we will try to have a full suite of display adapters, new versions seem to appear every day. Please have practiced plugging your laptop into an external display and setting your mirroring/speaker mode as you like it. You know your computer best.</p><p>We will also have a microphone in all rooms where recording is taking place. Please use the microphone and don't forget to repeat questions.
"),
				 array("q" => "Is there any financial support for speakers?", "a" => "We are unable to provide financial support, travel coverage, or accommodation for speakers. We deeply appreciate your contribution and support in making this community event possible!"),

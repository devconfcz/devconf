	...
	$questions = array(
		...
		array("group" => "Schedule / CfP Questions", "id" => "schedule", 
			"questions" => array( 
				...
				array("q" => "When should I expect to receive an acceptance notification by?", "a" => "We receive a large number of high quality submissions. We hope to send out acceptances by mid July 2021"),
		...
		array("group" => "Registration Questions", "id" => "registration", 
			"questions" => array( 
				array("q" => "How much does it cost to attend DevConf.US?  Do I need to register?", "a" => "Admission to DevConf.US is free and only requires that you register. Registration details will be available by August 2021."),
				array("q" => "If the conference is free, why do I have to register?", "a" => "We use registration to manage several logistics issues around DevConf.US, most importantly our virtual platform requires registration")
			)),
...
<section class="mx-auto mt-5 pt-5 pb-3 col-lg-11">
    ...
    <div class="row">
       <div class="h3 mx-5 mont-700 position-relative">We are excited to organize another Virtual DevConf.US with you!</div>
    </div>

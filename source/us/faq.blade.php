	...
	$questions = array(
		array("group" => "General Questions", "id" => "general", 
			"questions" => array( 
				...
				array("q" => "Will the workshops be live-streamed or pre-recorded?", "a" => "We are planning to include a day of live workshops on 23 September 2020.  You'll notice the CfP for workshops closes earlier than sessions, on 8 July 2020.  This is to allow plenty of time to work out the logistics of the workshops."),
		...
		array("group" => "Speaker Questions", "id" => "speaker", 
			"questions" => array( 
				...
				array("q" => "What else should I know?", "a" => "We're excited for our first Virtual DevConf.US.  We hope you'll be patient with us as we work out the details, together. Please email us at <a href='mailto:info@devconf.us'>info@devconf.us</a> with any other questions you have!")
		)),

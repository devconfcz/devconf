	...
	$questions = array(
		...
		array("group" => "Speaker Questions", "id" => "speaker", 
			"questions" => array(
                ...
                array("q" => "Are there any video recording guidelines?", "a" => "Yes! We are putting together steps on how to record an awesome video with the open source software OBS. If you're struggeling with OBS software, you can reach to us at <a hrefr='mailto:speakers@devconf.cz'>speakers@devconf.cz</a> mailing list. "),

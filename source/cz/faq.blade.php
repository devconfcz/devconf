...
//				array("q" => "It's after the deadline and I haven't received an acceptance notification. What do I do?", "a" => "We receive an amazingly large number of high quality submissions. Our track teams that review the talks have to work a lot to read and decide on them all. We have expect to send out the first round of acceptances around November 30, 2020."),
        ...
        array("group" => "Communication channel - Matrix", "id" => "matrix", 
			"questions" => array( 
				array("q" => "What is Matrix?", "a" => "Matrix is an open standard for interoperable, decentralized, real-time communication over IP. Learn more at <a href='https://matrix.org/faq/' target='_blank'>https://matrix.org/faq/</a>."),
                array("q" => "What is DevConf.cz Matrix server and what is it for?", "a" => "We're piloting Matrix at DevConf.cz 2023 with a goal to enhance communication and collaboration during the conference. Here's what you should know:</p><ul><li>It provides virtual rooms that correspond to each physical room at the event. Our goals include:<ul><li>Facilitating seamless communication for local and remote attendees.</li><li>Allowing attendees to actively participate in Q&A by submitting and upvoting questions.</li><li>Keeping attendees informed with important announcements and updates related to the conference.</li></ul></li><li>The Matrix server is being tested during DevConf.cz 2023 as a part of our transition from other proprietary communication tools.</li><li>It's hosted by the Red Hat OSPO (Open Source Program Office) team.</li></ul><p>By leveraging the DevConf.cz Matrix server, we aim to create an interactive and inclusive conference experience for all participants."),
                array("q" => "I don't have a Matrix account.", "a" => "While the devconf.cz server does not support user registrations, you can create an account on any other suitable Matrix server. Here are some examples:</p><ul><li>matrix.org - A server provided by the Matrix Foundation</li><li>
Your community's server if you plan to use the account as a contributor, not just during DevConf.cz (e.g. Fedora, Mozilla etc.)</li><li>You can also find a potentially helpful list of public servers at <a href='https://joinmatrix.org/servers/' target='_blank'>https://joinmatrix.org/servers/</a></li><li>
Another option is to host or self-host your own server. For more information, visit <a href='https://matrix.org/hosting/' target='_blank'>https://matrix.org/hosting/</a> or <a href='https://github.com/spantaleev/matrix-docker-ansible-deploy' target='_blank'>https://github.com/spantaleev/matrix-docker-ansible-deploy</a></li></ul><p>You can choose the client based on your preferences. We recommend using Element because it supports all features we use at DevConf.cz, such as  “spaces”, “threads” and “pinned events”."),
                ...
                array("q" => "Will the server stay online indefinitely, or just for the duration of the conference?", "a" => "The server will be online for the duration of the conference as part of our pilot initiative. We believe Matrix offers the best possible solution for mixing local and remote attendees, and we have already invested significant effort into its implementation. While we cannot guarantee its continued availability beyond the conference, we are committed to exploring Matrix as a long-term communication solution. Your feedback and experience during this pilot phase will be valuable in shaping our future decisions."),
                ...
                array("q" => "I can't see any rooms.", "a" => "When using the Element client to access #2023:devconf.cz, you should see three sub-spaces: ‘General', ‘Sessions' and ‘Workshops & Meetups'. If your client does not display the spaces correctly, you should still be able to see the “Main Chat” room and all the “Sessions” rooms when using the ‘explore' feature. Workshops & Meetups are not listed, and you will need their address or invite link to access them. If you still can't find any DevConf room, make sure you're searching within the devconf.cz server."),

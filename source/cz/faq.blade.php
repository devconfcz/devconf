...
/*                array("q"=>"What is DevConf.cz Mini?", "a"=>"DevConf.cz Mini is a bi-annual, highly focused, local, in-person version of DevConf.cz. It offers an opportunity to return to our conference themes in a smaller setting and establishes a platform for the Czech Republic and EMEA based community to sync, share and hack on upstream projects together."),
                ...
                array("q" => "How can I submit a proposal to DevConf.cz or DevConf.cz Mini conference?", "a" => "We have to comply with the appropriate government regulations in this area. You can find the latest Covid regulations here: <a href='https://covid.gov.cz/en/' target='_blank'>https://covid.gov.cz/en/</a>."),
                array("q" => "What are the in-person attendance guidelines?", "a" => "You can find all currently open devconf-related CfPs here: <a href='https://cfp.devconf.info' target='_blank'>https://cfp.devconf.info</a>. We also updated the events timeline on our <a href='/cz'>website</a>."), 

...
<?php
	$questions = array(
		...
		//		array("q" => "What do the hoodie Cut Types mean on the speaker acceptance form?", "a" => "A fitted cut used to be referred to as a female cut. It tends to hug the body closely and curve in at the waist.<br><br>A straight cut used to be referred to as a male cut. It is a straight down and fits better on bodies with fewer curves."),
				...
				array("q" => "What should I know if I lead a workshop?", "a" => "Bandwidth is shared by everyone and we occasionally experience issues with overloaded wifi which is beyond our power to fix. Please, prepare to switch from a workshop to a demo or guided tour where you are the only one who has access to the internet. This way your attendees will still get value from the session.  We really look forward to the year of \"Good Conference WiFi.\""),
		)),

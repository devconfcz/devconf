...
<?php
	$questions = array(
		array("group" => "General Questions", "id" => "general", 
			"questions" => array( 
                array("q" => "What is the official chat platform for the conference?", "a" => "We use Matrix as the official chat communication platform. Matrix offers an open, federated, and extensible communication ecosystem that aligns with our goals of fostering collaboration and adhering to open-source principles. We encourage you to join us on Matrix for all chat-related discussions during the event."),
...
"),
    ...
    array("group" => "CfP Questions", "id" => "cfp", 
			"questions" => array( 
                ...
                array("q" => "What is a booth?", "a" => "A booth is a staffed table at the event. Booths are open to all participants at all times, and they serve as a place for conversations about the project and interaction with contributors, users, and attendees. <strong>Using the booth for promoting or selling your products is not allowed.</strong></p><p>There must be <strong>at least one person at the booth at all times</strong> and there must be <strong>at least two staff members registered.</strong> Preference is given to booths that will run both days."),
		...
		array("group" => "Speaker Questions", "id" => "speaker", 
			"questions" => array(
				...
				array("q" => "Can I edit my session title or abstract?", "a" => "Yes, the platform allows you to make minor adjustments to your title or abstract for clarity. However, please do not change the core proposal significantly. Our reviewers selected your session based on the specific content submitted, and we expect the final presentation to reflect that original topic."),
				array("q" => "Can I add another speaker to my session?", "a" => "Please do not add additional speakers via the platform without contacting us first at speakers@devconf.cz. We accepted your submission based on the specific number of speakers listed.</p><p>Additionally, we maintain a strict limit of two speakers per session. Any sessions found with more than two speakers will be reverted to their original state.
"),
				array("q" => "What if I can no longer attend? Can someone else present for me?", "a" => "If you are unable to attend but have a colleague who can deliver the session in your place, we generally do allow for substitutions. Please reach out to us at speakers@devconf.cz with the details of the new speaker so we can manually update the session records for you."),
		)),
		
		array("group" => "Sponsorships and Community Presence", "id" => "sponsorships", 
			"questions" => array( 
				...
				array("q" => "If you don’t have sponsors, how can my project or organization be represented?", "a" => "While we don’t have financial sponsors, we provide a dedicated Showfloor at the venue specifically for showcasing open source technologies and projects. This is a space for communities to engage with attendees, demonstrate software, and share their mission."),
        ...
        array("group" => "Matrix questions", "id" => "matrix", 
			"questions" => array( 
                ...
                array("q" => "What is the DevConf.cz Matrix server for?", "a" => "We're using Matrix at DevConf.CZ 2026 to enhance communication and collaboration during the conference. It provides virtual rooms that correspond to each physical room at the event. These rooms:</p><ul><li>Facilitate seamless communication for local and remote attendees.It provides virtual rooms that correspond to each physical room at the event.</li><li>
Allow attendees to actively participate in Q&A by submitting and upvoting questions.</li><li>Keep attendees informed with important announcements and updates related to the conference.</li></ul><p>It's hosted by the Red Hat OSPO (Open Source Program Office) team.</p><p>By leveraging the DevConf.CZ Matrix server, we aim to create an interactive and inclusive conference experience for all participants."),
                array("q" => "How do I join?", "a" => "Open <a href='https://matrix.to/#/#2026:devconf.cz' target='_blank'>https://matrix.to/#/#2026:devconf.cz</a> to get started."),
                ...
                array("q" => "Can I use my existing Matrix account?", "a" => "Absolutely! #2026:devconf.cz rooms are public and <a href='https://matrix.org/faq/#what-does-federated-mean%3F' target='_blank'>federated</a>, which means you can use your existing account to join. Open <a href='https://matrix.to/#/#2025:devconf.cz' target='_blank'>https://matrix.to/#/#2025:devconf.cz</a> to get started."),
                ...
                array("q" => "What Matrix client(s) can I use?", "a" => "In theory, any client should allow you to join the devconf.cz rooms. However, not all clients support all features, #2026:devconf.cz for example takes advantage of “spaces”, “threads” or “pinned events”. If your client does not support these features, you may not have the optimal experience. We recommend using <a href='https://element.io/download' target='_blank'>Element</a>, because it supports all features we use."),
                array("q" => "I can't see any rooms.", "a" => "When using the <a href='https://element.io/download' target='_blank'>Element</a> client to access #2026:devconf.cz, you should see three sub-spaces: ‘General', ‘Sessions' and ‘Workshops & Meetups'. If your client does not display the spaces correctly, you should still be able to see the “Main Chat” room and all the “Sessions” and “Workshops & Meetups“ rooms when using the ‘explore’ feature. If you still can’t find any DevConf room, make sure you’re searching within the devconf.cz server."),

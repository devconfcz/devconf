...
@section('title')
<title>FAQ - DevConf.CZ 2020</title>
@endsection
	...
	$questions = array(
		...
		array("group" => "Getting around Brno and to DevConf", "id" => "around", 
			"questions" => array( 
				...
				array("q" => "Are there taxis?", "a" => "We recommend downloading the <a href='https://www.liftago.com/'>Liftago</a> app to book a taxi electronically. It is also possible to reserve a taxi using your mobile phone, but usually you will need to be able to speak Czech to use phone based services."),
		...
		array("group" => "Schedule / CfP Questions", "id" => "schedule", 
			"questions" => array( 
				array("q" => "Where is the schedule? When will the Schedule be ready?", "a" => "We hope to release the schedule around 10 December 2018.  We are currently confirming the order of tracks with our track captains, waiting on confirmations from speakers that they will be able to attend and filling in the gaps, holes and other “wiggly bits” in the schedule.<br><br>We are planning to start at 9am on 25 January 2019 and end at 4pm on 27 January 2019. These time may change slightly, so do watch for the final schedule."),
				array("q" => "It’s after the deadline and I haven’t received an acceptance notification.  What do I do?", "a" => "We received an amazingly large number of high quality submissions. Our track teams that review the talks have had to work a lot to read and decide on them all. We have sent out the first round of acceptances around 26 November 2018. We are finalizing some issues around scheduling and room availability along with filling out the last slots.<br><br>If you haven’t received an acceptance yet, your talk isn’t necessarily rejected. We expect to send out the second round once we have received accepts and declines back from speakers in round 1 so we can most flexibly complete the schedule. This should late during the first week of December.<br><br>We have no further information available at this time."),
		...
		array("group" => "Registration Questions", "id" => "registration", 
			"questions" => array( 
				array("q" => "How much does it cost to attend DevConf.CZ?  Do I need to register?", "a" => "Admission to DevConf.CZ is free and only requires that you register for a free ticket. Register on-line <a href='https://www.eventbrite.com/e/devconfcz-2019-tickets-53807645115' target='_blank'>here</a>. Capacity is limited!<br><br>Onsite (at venue) registration is possible, even after on-line registration has closed, but it will also be limited capacity. You are strongly encouraged to register online to ensure you have a ticket."),

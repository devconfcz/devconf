...
<section id="speakers" class="mx-auto mt-5 pb-3 col-lg-11">
	<div class="row">
		...
		<!--	<p>If you do not require sponsorship to cover your accommodation, please fill out this <a href="https://fedoraproject.limequery.com/156983?lang=en" target="_blank">form</a> to book from our room block.</p>
            ...
            <p>As an accepted speaker, you will receive instructions on how to book from our room blocks as part of your acceptance letter between April 7–13, 2025. Please note that DevConf.CZ does not cover travel or accommodation expenses for speakers.</p>
		</div>
	</div>
</section>
<hr>
<section id="attendees" class="mx-auto mt-5 pb-3 col-lg-11">
	<div class="row">
		...
		<div class="os-400 mx-5">
			<p>We plan to publish the list of partner hotels, along with booking instructions for our room blocks, in mid-April.</p>
		</div>
	</div>
</section>
<!--<hr>

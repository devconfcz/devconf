...
<section id="speakers" class="mx-auto mt-5 pb-3 col-lg-11">
	<div class="row">
		...
		<!--	<p>If you do not require sponsorship to cover your accommodation, please fill out this <a href="https://fedoraproject.limequery.com/156983?lang=en" target="_blank">form</a> to book from our room block.</p>
            ...
            <p>All hotel rooms are already occupied.</p>
		</div>
	</div>
</section>
<hr>
<section id="attendees" class="mx-auto mt-5 pb-3 col-lg-11">
	<div class="row">
		...
		<div class="os-400 mx-5">
			...
			<p>All prices are per <strong>one night!</strong> The final price for accommodation depends on the partner hotel (accommodation taxes are usually charged on the spot). Contact the partner hotel directly to save your spot and for additional information.</p> -->
            <p>All hotel rooms are alreadz occupied.</p>
		</div>
	</div>
</section>
<hr>

...
<section class="mx-auto mt-5 pt-5 pb-3 col-lg-11">
	...
	<div class="row local-nav">
		<div class="mx-5  mt-4 os-400">
            ...
            <a href="#hybrid">Information about the hybrid conference</a>
...
<br>
<section id="hybrid" class="mx-auto col-lg-11">
        <div class="row">
                <div class="h2 pt-3 pb-4 mx-5 mont-700">Information about the hybrid conference</div>
            <div class="os-400 mx-5">
                We are planning for a hybrid conference, if COVID restrictions allow for it. This means that there will be a mix of in-person and virtual participants, including speakers. However you are planning to attend, it is important to think about how to engage your hybrid audience.
            <div>
        <br>
              <div class="h4 pt-2 pb-2 mx-5 mont-700">For in-person attendees:</div>
            <div class="os-400 mx-5">
                <ul>
                    <li><a href="https://covid.gov.cz/en/" target="_blank">Laws and restrictions in the Czech Republic</a> are subject to constant change. We will try to update you with new information, but please stay informed yourself as well. We are sorry for these inconveniences, but thrilled that you decided to join us in person!</li>
                    <li>Carry a respirator and your vaccination certificate with you wherever you go.</li>
                    <li>Know your hardware! Practice the technical aspects of giving your talk like having the right connectors / adaptors / pointers. </li>
                </ul>
            </div>
            <div class="h4 pt-2 pb-2 mx-5 mont-700">For virtual attendees:</div>
            <div class="os-400 mx-5">
                <ul>
                <li>Join our <a href="https://discord.com/" target="_blank">Discord channel</a></li>

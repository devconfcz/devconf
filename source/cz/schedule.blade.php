...
<?php
	...
	$schedule = array(
	    array("start"=>"14:00", "items"=>array(
    	    array("end"=>"14:15", "length"=>15, "name"=>"Welcome", "room"=>"D2")
    	)),
        array("start"=>"14:15", "items"=>array(
            array("end"=>"14:55", "length"=>40, "name"=>"Keynote - Panel: This is how we use hybrid cloud", "description"=>"Linux Integration Engineering teams (formerly Cyborg) will show you how we embrace hybrid cloud, Red Hat's and IBM's strategic direction. There are many projects and services in our department that deploy into multiple platforms, datacenters and public clouds. Panelists are seasoned engineers who have years of experience in development, maintenance, service architecture, scalability and security. If you are working on microservices, in DevOps or SRE, or develop a service, you cannot miss this session.", "track"=>"Cloud & Hyperscale", "room"=>"D2",
                "speakers"=>array(
        ...
        array("start"=>"15:00", "items"=>array(
            array("end"=>"15:40", "length"=>40, "name"=>"Easy management of VMs with OpenShift Pipelines", "description"=>"", "track"=>"Cloud & Hyperscale", "room"=>"D2",
                "speakers"=>array(
            ...
            array("end"=>"15:40", "length"=>40, "name"=>"Self service cluster deployment using MCE", "description"=>"", "track"=>"Cloud & Hyperscale", "room"=>"D3",
                "speakers"=>array(
        ...
        array("start"=>"16:00", "items"=>array(
            ...
            array("end"=>"16:40", "length"=>40, "name"=>"Performance Under Control", "description"=>"A tool for performance versioning.", "track"=>"Future Tech and Open Research", "room"=>"D3",
                "speakers"=>array(
        ...
        array("start"=>"17:00", "items"=>array(
            array("end"=>"17:20", "length"=>20, "name"=>"Migration toolkit for Virtualization", "description"=>"Get your VMs into Cloud!", "track"=>"Cloud & Hyperscale", "room"=>"D2",
                "speakers"=>array(
                    array("name"=>"Martin Nečas", "img"=>"", "socials"=>array("linkedin"=>"https://cz.linkedin.com/in/martinnecas","github"=>"https://github.com/mnecas"))
                )
            ),
            array("end"=>"17:20", "length"=>20, "name"=>"500 commits journey to Kubernetes", "description"=>"In 2019 Zeta Global DevOps team started the long journey to the world of hybrid cloud. Since then we went through a successful migration of the business services from bare-metal servers to containerized setup, employing Kubernetes as a scheduler, and GitOps Toolkit as the entry point to the cluster.</p><p>During the talk I'll be sharing how our cluster deployment and maintenance processes and tooling matured, and how we worked with Engineering on making Zeta applications cloud-ready.</p><p>The talk is dedicated to the problem of going from bare-metal deployments to containers, and to the Kubernetes, and covers Zeta Global Kubernetes infrastructure in full.</p><p>We had a long journey, and I hope our experience will be helpful to both DevOps and Engineering organizations in other companies.", "track"=>"Cloud & Hyperscale", "room"=>"D1",
                "speakers"=>array(
                    array("name"=>"Vasyl Kaigorodov", "img"=>"", "socials"=>array("github"=>"https://github.com/br0ziliy"))
                )
            ),
            ...
            array("end"=>"17:50", "length"=>50, "name"=>"Workshop: Implify your Deployments with tanka and jsonnet", "description"=>"There are many configuration management approaches for Kubernetes. From plain yaml to complex Ansible Playbooks, everything is possible. We evaluated many solutions and found our perfect match with tanka and jsonnet. In this workshop session, we'll migrate a yaml based Kubernetes deployment to tanka/jsonnet together and refine it for scale. Afterwards, you'll be able to simplify repetitive Kubernetes configurations and reuse common components across multiple projects. To follow this workshop, you'll either need a Linux or MacOS workstation. WSL2 will also work.", "track"=>"Workshop", "room"=>"S505",
                "speakers"=>array(
		...
		array("start"=>"17:30", "items"=>array(
		    array("end"=>"17:50", "length"=>20, "name"=>"log2rbac - Kubernetes operator that helps you to set up your RBAC rules correctly", "description"=>"Linux Integration Engineering teams (formerly Cyborg) will show you how we embrace hybrid cloud, Red Hat's and IBM's strategic direction. There are many projects and services in our department that deploy into multiple platforms, datacenters and public clouds. Panelists are seasoned engineers who have years of experience in development, maintenance, service architecture, scalability, and security. If you are working on microservices, in DevOps or SRE, or develop a service, you cannot miss this session.", "track"=>"Cloud & Hyperscale", "room"=>"D2",
                "speakers"=>array(

	...
	<div class="row mr-0 mt-5" style="height: 85%">
		...
		<div class="col-lg-10 h-100 px-0">
			...
			<div class="heading-text pt-1 pt-lg-5 mt-1 mt-lg-5">
				<a href="https://www.youtube.com/playlist?list=PLU1vS0speL2Z08BeKSwSqfxPEl3ta5UK3" target="_blank" class="border p-3 h2 mont-700" style="border-width: 3px !important;">RECORDINGS ARE NOW AVAILABLE</a>
			</div>
		</div>
	</div>
</header>
...
-->				</div>
		...
		<div class="col-10 col-md-5 ml-md-0 mx-auto py-3 border-bottom">
			<div class="row">
				<div class="col-4 h5 mont-700">Dec 9, 2019</div>
				<div class="col-8">
					<div class="row">
...
<section id="schedule" class="mx-auto col-lg-12 background-gray text-center mt-5 py-5">
	...
	<a class="p-3 mont-700 mb-3 d-inline-block purple-href" target="_blank" href="https://devconfcz2020a.sched.com/">SEE SCHEDULE</a>
</section>

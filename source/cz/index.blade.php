	...
	<div class="row mr-0 mt-5" style="height: 85%">
		...
		<div class="col-lg-10 h-100 px-0">
			...
			<div class="heading-text pt-1 pt-lg-5 mt-1 mt-lg-5">
				...
				<a href="https://cfp.devconf.info" target="_blank" class="border p-3 h2 mont-700" style="border-width: 3px !important;">CFP FOR LIGHTNING TALKS IS OPEN</a>
			</div>
		</div>
	</div>
</header>
...
<section id="poll" class="mx-auto col-lg-11">
    <div class="row mt-4 py-5">
        <div class="col-lg-4 mx-5 mb-5 text-center">
            <img src="/assets/images/devconf-d-lidizbaru.png" class="mw-100" alt="Lidi z Baru DevConf image asset">
        </div>
        <div class="col-lg-6 px-5">
            ...
            <div class="os-400">
                ...
                <p>Lidi z Baru has given us a list of 24 ingredients to choose from. We've chosen the top 5 ingredients based on your votes, and they will go into 3 DevConf.CZ signature drinks. Three bartenders from Lidi z Baru 
                   will each be assigned their own mocktail, and will create the drinks from their homes on camera during the session.</p>

                <p>If you want to join in from home, you will need the following besides the top 5 picks from the poll: salt, sugar, honey, black pepper, milk, egg, lemon and (sparkling) water. We will publish the list of 
                   ingredients you need to buy in advance on our website and social media. Join us on Friday to make a mocktail live and connect with other attendees and speakers afterwards. You are welcome to join the fun 
                   even if you don't plan to make a mocktail.</p>
            </div>
        </div>
    </div>
</section>

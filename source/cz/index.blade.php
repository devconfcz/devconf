	    ...
	    <div class="row py-4">
			...
			<?php
				...
				$topics = array(
                        ...
                        array("name"=>"Modern Software Development", "description"=>"Trending topics from software development, application modernization, new trends, microservices, and distributed computing. Development of secure code, code validation and verification."),
...
-->
	...
	<div class="row">
		<div class="col-10 mx-auto">
            <p class="os-400"><span class="h6 mont-700">Aug 26, 2021</span> CfP is open! <a href="https://discord.gg/devconf" target="_blank">Submit your proposal</a> until Oct 24th, 2021.</p>

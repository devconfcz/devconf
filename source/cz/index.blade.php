    ...
    <div class="row mt-4 py-5">
	    ...
	    <div class="row py-4">
			...
			<?php
				...
				$topics = array(
						array("name"=>"Cloud, Hybrid Cloud, and Hyperscale Infrastructure", "description"=>"Topics around Kubernetes, containers, and virtualization that power anything from small private clouds to large data centers. It should focus on best practices for infrastructure management, operations at scale, high availability, and resource efficiency. Proposals are welcome on networking, storage, and security in multi-cloud and distributed environments.<br><br>Key words: <i>Containers, Kubernetes, KubeVirt, KVM, OpenStack, Cloud Native, Scalability, Availability, Data Center, Private Clouds, Public Cloud, Hybrid Cloud, Virtualization</i>"),
                        array("name"=>"Future Tech and Open Research", "description"=>"Track for all topics with the potential to be the next big thing. Novel solutions and technologies actively discussed, research still a few years from production. Showcasing your own original research as well as collaborations between the industry and academia are welcome. Novel topics in AI/ML, hybrid cloud, software development, productivity, networking, edge, sustainability, security, reliability and other areas.<br><br>Key words: <i>Emerging Technologies, Applied Research, Prototypes, Proof of Concepts, User Studies, Data Insights</i>"),
                        array("name"=>"Artificial Intelligence and Data Science", "description"=>"Topic for artificial intelligence, statistics and machine learning, both theory and practice. Do you have an AI application to demonstrate, novel architecture, performance comparison or a data processing pipeline you are really proud of? How about deep diving into model training and inference, integrating with agentic AI frameworks, and scaling workflows with MLOps? This is the track for you. The only requirement is that artificial intelligence must be central to it.<br><br>Key words: <i>Open Data Hub, LLM, PyTorch, llama.cpp, vLLM, llm-d, KServe, Kubeflow</i>"),
                        array("name"=>"Linux Distributions, Operating Systems, and Edge", "description"=>"Everything related to Linux-based operating systems with a focus on Fedora Linux, CentOS Stream, CoreOS, and Silverblue. Topics can include the operating system or new technologies and features such as bootc, immutable systems, dnf5, Konflux, edge, and automotive. All levels are welcome, from kernel and hardware, through operating system components and desktop news. Tools and processes for building distributions are also a great fit.<br><br>Key words: <i>Operating Systems, Kernel, Edge, Automotive/SDV (software defined vehicle), Linux, dnf5, RPM, bootc, Project Hummingbird, Konflux, RISC-V</i>"),
                        array("name"=>"Programming and Application Development", "description"=>"Topics around programming, programming languages and language development, programming tools, libraries and application services, and development platforms. Also covers porting applications between platforms or architectures.<br><br>Key words: <i>Programming, Python, Java, JavaScript, TypeScript, Rust, Golang, IDE, Cursor, App Development, Web App, Mobile, Developer Tools, Porting, AI-assisted Coding</i>"),
                        array("name"=>"DevOps, CI/CD, and Automation", "description"=>"Topics related to DevOps culture and CALMS (Communication/Culture/Collaboration, Automation, Lean, Measurement/Metrics, Sharing); adding continuous integration, continuous delivery, and continuous deployment (CI/CD) into workflows; defining a release pipeline; automating developer environments; and building environments from developer sandboxes to production. This track covers ensuring application uptime, continuous application development, and agile development practices. It also includes discussions on Site Reliability Engineering (SRE) tools and best practices, chaos experiments, and testing strategies in integrated environments. Additional focus areas include embedded intelligence in products for automation and the role of AI in test failure analysis, test generation, and test selection.<br><br>Key words: <i>CALMS, Automation, DevOps, Ansible, AIOps, CI/CD, Tekton, ArgoCD, SRE, Chaos Engineering, Monitoring, Observability</i>"),
                        array("name"=>"Security and Compliance", "description"=>"This track focuses on the critical intersection of security, compliance, and the open source ecosystem. We explore the integration of security into the entire software development lifecycle, integrating \"Shift Everywhere\" principles, securing the software supply chain, and managing compliance in complex deployments. We’re happy to consider variety of security topics, but we specifically invite proposals that address implementation challenges of the Zero-Trust, Post-Quantum Cryptography (PQC), Confidential Computing, and the dual role of AI/ML in both security automation and new threat vectors. Beyond the code, this track examines the governance of open source security - including the role of OSPOs, security education, and community advocacy - as well as the impact of evolving global legislation affecting the open source ecosystem.<br><br>Key words: <i>Remote Attestation, Policy as Code, PQC, Identity Management, MFA, Zero Trust, Data Governance, CRA, DORA, NIS2, Confidential Computing, SBOM, SDLC, Vulnerability Management, Configuration Compliance, FIPS, Auditing, Supply Chain Security, OSPOs, AI Trust and AI Safety, Open Source Security Advocacy, Licensing</i>"),
                        array("name"=>"Agility and Leading Principles", "description"=>"This track explores how agility is driven by influence and effective approaches at every level. We invite contributors bringing best practices that support resilient team cultures, foster psychological safety, and build effective high-performing teams. Learn how to align lean and agile practices with strategic thinking to drive innovation and unlock your team’s full potential.<br><br>Key words: <i>Agile Transformation, Business Agility, Lean Principles, Continuous Improvement, Agile Leadership, Scaling Agile, Agile Coaching, Culture, Collaboration, Facilitation, Mentorship, Product Ownership, Change Management, Decision Making, Strategic Thinking, Customer Feedback, Talent Development</i>"),
                        array("name"=>"Open Track", "description"=>"Open to any other topics that don't fall under the listed themes but relate to open source and communities! We welcome open source student projects, presentations of diploma and bachelor degree theses, and ideas for new projects. We would also like to see topics that relate to open source community leadership, examples of open source initiatives in the public sector, and topics on the journey from zero to a successful open source project. Other topics can include UX and design topics, and open hardware.<br><br>Key words: <i>Student Projects, Diploma Theses, Bachelor Theses, New Project Proposals, Open Source Community, Community Building, Contributor Experience, Open Source Governance, Project Health, Academic Open Source, Public Sector Open Source, Open Source in Education, UX, UI, Design, Design Thinking, Hacking</i>")
					  );
...
<!--		<div class="col-10 col-md-5 mr-md-0 mx-auto py-3 border-bottom">
	...
	<div class="row">
		<div class="col-lg-6 px-5 mx-auto">
             ...
             <p class="os-400"><span class="h6 mont-700">Dec 15, 2025</span> DevConf.CZ 2026 date announced: June 18-20, 2026</p>

	    ...
	    <div class="row py-4">
			...
			<?php
				...
				$topics = array(
                        ...
                        array("name"=>"Artificial Intelligence and Data Science", "description"=>"Artificial intelligence, data storing and processing, best practices for data lakes/data mesh, and parallelism and vector computing."),

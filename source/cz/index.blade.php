            ...
            <div class="row py-5">
			    <div class="col-xl-6">
                    ...
                    <div class="heading-text pt-1">
                        <a href="/cz/map/" class="border p-3 h2 mont-700" style="border-width: 3px !important;">Venue map</a>
                    </div>
                    <div class="heading-text pt-1">
                        <a href="#registration" class="nav-link local border p-3 h2 mont-700" style="border-width: 3px !important;">Registration</a>
                    </div>
<!--                     <div class="heading-text mont-400 h5 pb-2 pb-lg-5">
...
<section id="about" class="mx-auto col-lg-11">
	<div class="row mt-4 py-5">
		...
		<div class="col-lg-6 px-5">
			...
			<div class="os-400">
                <p><strong>DevConf.CZ</strong> is a community conference for developers, admins, DevOps engineers, testers, documentation writers and other contributors to open source technologies.</p>
...
<section id="registration" class="mx-auto col-lg-11">
    <div class="mt-4 py-5">
        ...
        <link rel="stylesheet" type="text/css" href="https://pretix.eu/devconf/devconfcz2024/widget/v1.css">
        <script type="text/javascript" src="https://pretix.eu/widget/v1.en.js" async></script>

        <div class="pretix-widget-compat" event="https://pretix.eu/devconf/devconfcz2024/" single-item-select="button"></div>
        <noscript>
           <div class="pretix-widget">
               <div class="pretix-widget-info-message">
                    JavaScript is disabled in your browser. To access our ticket shop without JavaScript, please <a target="_blank" rel="noopener" href="https://pretix.eu/devconf/devconfcz2024/">click here</a>.
                </div>
           </div>
        </noscript>
    </div>

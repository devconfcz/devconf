...
<header class="masthead min-vh-100">
	...
	<div class="row mr-0 mt-5" style="height: 85%">
		<div class="col-lg-1 border-right text-center pr-0">
			...
			<a href="https://matrix.devconf.cz" target="_blank" title=""><img src="/assets/images/matrix.svg" alt="matrix" class="social-icon"></a>
...
<!--		<div class="col-10 col-md-5 mr-md-0 mx-auto py-3 border-bottom">
	...
	<div class="row">
		<div class="col-lg-6 px-5 mx-auto">
             <p class="os-400"><span class="h6 mont-700">Jun 9, 2023</span> Join our <a href="https://matrix.devconf.cz" target="_blank">matrix server</a> to interact with other attendees and ask questions during sessions anywhere you are.</p>

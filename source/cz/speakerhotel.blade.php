...
<section class="mx-auto mt-5 pt-5 pb-3 col-lg-11">
	<div class="row">
		...
		<div class="os-400 mx-5">
			...
			In a case that the secondary speaker is of a different gender than primary speaker and they require a separate room, we can cover the separate room. In both cases, 
			please let us know at <a href="mailto:speakers@devconf.cz">speakers@devconf.cz</a> before you reach out to the hotel.</p>

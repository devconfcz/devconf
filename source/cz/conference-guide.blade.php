...
<section class="mx-auto mt-5 pt-5 pb-3 col-lg-11">
	...
	<div class="row local-nav">
		<div class="mx-5  mt-4 os-400">
			...
			<a href="#support">Conference support and where to test your A/V setup</a>
...
<section id="support" class="mx-auto col-lg-11">
	<div class="row">
		...
		<div class="h4 pt-3 pb-4 mx-5 mont-700 w-100">Conference support and where to test your A/V setup</div>

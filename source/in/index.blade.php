	...
	<div class="row mr-0 mt-5" style="height: 85%">
		...
		<div class="col-lg-10 h-100 px-0">
			...
			<div class="heading-text pt-5 mt-5">
                        <a href="#" class="nav-link local border p-3 h2 mont-700" style="border-width: 3px !important;">Schedule and Registration Coming Soon</a>
                    </div>
                     <div class="heading-text mont-400 h5 pb-2 pb-lg-5">
                       Registration opens in January 2025, and the schedule will be published by the end of January 2025.
        			</div>
			</div>
		</div>
	</div>

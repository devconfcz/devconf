...
<section id="about" class="mx-auto col-lg-11">
	<div class="row mt-4 py-5">
		<div class="col-lg-4 mx-5 mb-5 text-center">
			<img src="/assets/images/devconf-d-brno.png" class="mw-100" alt="Brno DevConf image asset">
		</div>
		...
		<div class="col-xl-3 container card-body my-2 ml-xl-auto mr-xl-3" style="background: #ada3ff">
			<div class="row h-100 align-items-center">
				<div class="col text-center">
					...
					<h2 class="mont-700 mb-0">Getting around Bengaluru</h2>
					<div class="card-text os-400 pt-3">Bengaluru has a 24 hour public transit system and the site is accessible by car.</div>
					<p class="card-text my-5">
						<a href="/in/aroundbengaluru" class="border p-3 mont-700">MORE INFORMATION</a>
					</p>
				</div>
			</div>
		</div>
		<div class="col-xl-3 container card-body my-2 mx-xl-3" style="background: #4a4a7e">
			<div class="row h-100 align-items-center">
				<div class="col text-center">
					...
					<h2 class="mont-700 pb-4">Getting to Bengaluru</h2>
					<div class="card-text os-400 pt-4">Bengaluru is easily accessible by car, bus, train and plane.</div>
					<p class="card-text my-5">
						<a href="/in/tobengaluru" class="border p-3 mont-700">MORE INFORMATION</a>
					</p>
				</div>
			</div>
		</div>
		<div class="col-xl-3 container card-body my-2 ml-xl-3 mr-xl-auto" style="background: #8e83e4">
			<div class="row h-100 align-items-center">
				<div class="col text-center">
					...
					<p class="card-text my-5">
						<a href="/in/hotels" class="border p-3 mont-700">MORE INFORMATION</a>
					</p>
				</div>
			</div>
		</div>

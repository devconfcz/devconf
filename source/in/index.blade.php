	...
	<div class="row mr-0 mt-5" style="height: 85%">
		...
		<div class="col-lg-10 h-100 px-0">
			...
			<div class="heading-text pt-5 mt-2">
                <a href="https://pretalx.devconf.info/devconf-in-2027/cfp" target="_blank" class="nav-link local border p-3 h2 mont-700" style="border-width: 3px !important;">CALL FOR PROPOSALS</a>
            </div>
            ...
            <div class="heading-text mont-400 h5 pb-2 pb-lg-2">
                 Submit your proposals by November 8, 2026.
            </div>
...
<section id="partners" class="mx-auto py-5 col-lg-11">
	    ...
	    <div class="row px-5 mx-auto">
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		        <img src="/assets/images/partners/ac.png" class="w-75">
		    </div>
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		        <img src="/assets/images/partners/cncgp.png" class="w-75">
		    </div>
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		        <img src="/assets/images/partners/docker.png" class="w-75">
		    </div>
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		        <img src="/assets/images/partners/eugp.png" class="w-75">
		    </div>
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		        <img src="/assets/images/partners/foss.svg" class="w-75">
		    </div>
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		    ...
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		        <img src="/assets/images/partners/ke.svg" class="w-75">
		    </div>
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		        <img src="/assets/images/partners/lc.svg" class="w-75">
		    </div>
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		        <img src="/assets/images/partners/np.png" class="w-75">
		    </div>
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		        <img src="/assets/images/partners/pac.png" class="w-75">
		    </div>
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		        <img src="/assets/images/partners/pcp.jpg" class="w-75">
		    </div>
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		        <img src="/assets/images/partners/pd.jpeg" class="w-75">
		    </div>
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		        <img src="/assets/images/partners/pdc.png" class="w-75">
		    </div>
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		        <img src="/assets/images/partners/rh.jpg" class="w-75">
		    </div>
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
		        <img src="/assets/images/partners/sas.png" class="w-75">
		    </div>
		    <div class="col-lg-2 col-6 px-3 mx-auto align-content-center text-center">
...
<section id="news" class="mx-auto py-5 col-lg-11">
	    ...
	    <div class="row">
		    <div class="col-lg-6 px-5 mx-auto">
                 <p class="os-400"><span class="h6 mont-700">Sep 10, 2026</span> DevConf.IN 2027 <a href="https://pretalx.devconf.info/devconf-in-2027/cfp">CfP</a> is open and the deadline to submit your proposal is November 8, 2026.</p>
...
<section id="hotels" class="mx-auto py-5 col-lg-11">
	    ...
	    <div class="row">
		    <div class="col-lg-12 px-5 mx-auto">
                 <p class="os-400">More details are coming soon.</p>

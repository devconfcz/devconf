	...
	$questions = array(
		...
		array("group" => "CfP Questions", "id" => "cfp", 
			"questions" => array( 
				...
				array("q" => "What is a workshop?", "a" => "A workshop is a hands-on demo where you and other workshop leads interact with the audience with the goal to share your knowledge and experience on a particular bite-sized topic. The goal of a workshop is to teach or practice a skill. As a result, workshops should be actionable and goal-oriented.<br><br>A workshop is 80 minutes long. We allow up to 3 active presenters in a workshop. You must designate one of them to be the primary session leader.<br><br>All workshops are conducted live and are not recorded or streamed by default. If you want to stream the content online it is up to you to cover both offline and online channels."),
				array("q" => "What is a meetup?", "a" => "Meetups are organized as in-person meetings. They are open to all participants, and they serve as a place for open discussions during the dedicated time, sharing the latest project developments and interaction with contributors and attendees.<br><br>A meetup is 80 minutes long. We allow up to 3 active presenters in a meetup. You must designate one of them to be the primary session leader.<br><br>All meetups are conducted live and are not recorded nor streamed by default. If you want to stream the content online it is up to you to cover both offline and online channels."),
